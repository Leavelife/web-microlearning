...
import VirtualLabRJ45 from "@/components/VirtualLabRJ45";
import VirtualLabCables from "@/components/VirtualLabCables";
...
const CABLE_LIBRARY = [
  { id: "1", value: "white-orange", label: "Putih/Oranye", colorHex: "#fdf2e9" },
  { id: "2", value: "orange", label: "Oranye", colorHex: "#f97316" },
  { id: "3", value: "white-green", label: "Putih/Hijau", colorHex: "#dcfce7" },
  { id: "4", value: "blue", label: "Biru", colorHex: "#60a5fa" },
  { id: "5", value: "white-blue", label: "Putih/Biru", colorHex: "#dbeafe" },
  { id: "6", value: "green", label: "Hijau", colorHex: "#4ade80" },
  { id: "7", value: "white-brown", label: "Putih/Coklat", colorHex: "#f3e8ff" },
  { id: "8", value: "brown", label: "Coklat", colorHex: "#7c2d12" },
];
  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-md">
      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <div>
          <h2 className="text-xl font-semibold mb-2">Area Konektor</h2>
